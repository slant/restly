...
describe OauthResource::Base do

  subject { BaseSample }

  before do
    class BaseSample < OauthResource::Base
    end
  end
  ...
  describe "Defaults" do
    ...
    it "client has the default site" do
      subject.client.site.should == OauthResource::Configuration.site
    end

    it "client has the default client id" do
      subject.client.id.should == OauthResource::Configuration.client_id
    end

    it "client has the default client secret" do
      subject.client.secret.should == OauthResource::Configuration.client_secret
    end
  ...
  describe "Inherited Default Overrides" do
    ...
    it "inherited can set a custom site" do
      ...
      subject.client.site.should_not == OauthResource::Configuration.client_id
    end

    it "inherited can set a custom client_id" do
      subject.client_id = "custom_id"
      subject.client.id.should_not == OauthResource::Configuration.client_id
    end

    it "inherited can set a custom client_secret" do
      subject.client_secret = "custom_secret"
      subject.client.secret.should_not == OauthResource::Configuration.client_id
    end
